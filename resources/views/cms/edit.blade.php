...
<head>
    ...
    <title>Edit Tutorial | Dashboard | Ayolearn</title>
</head>
<body>
    <section class="mt-20 w-9/12 mx-auto mb-20">
        ...
        <div class="grid grid-cols-1 gap-4">
            <form enctype="multipart/form-data" method="POST" action="{{ route('admin.update.tutorial', $details->id) }}">
                @method('PUT')
                @csrf
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Title</label>
                  <input value="{{ $details->title }}" name="title" type="text" class="form-control" id="exampleInputEmail1"
                ...
                <div style="margin-bottom: 10px;">
                  <textarea id="tutorial" name="content" hidden>{!! $details->content !!}</textarea>
                  @error('tutorial')
